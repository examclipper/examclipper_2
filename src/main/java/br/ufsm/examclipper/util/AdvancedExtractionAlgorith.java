...
public class AdvancedExtractionAlgorith implements ExtractionAlgorithm {
    
    private List<Ruling> verticalRulings = null;
    
    public AdvancedExtractionAlgorith() {
    }
    
    public AdvancedExtractionAlgorith(List<Ruling> verticalRulings) {
